      ...
      <div className="mx-auto w-full max-w-[720px] px-5 pb-20">
        ...
        >
          ...
          <p className="mt-4 max-w-[58ch] text-sm leading-relaxed" style={{ color: INK_1 }}>
            ...
            editing and motion design. I founded it at 16. A minor cannot do
            that alone in Germany: it takes both parents&rsquo; consent and
            approval from the family court. Snowmate is the product I build on
            the side.
          </p>
